...
const WhyUs = () => {
  return (
    <div className='px-[5px] mb-12 max-w-[400px] m-auto md:max-w-none md:pl-0 md:mb-20'>
        <h2 className='font-bold text-[20px] text-center mb-8 sm:text-[28px]  lg:text-[48px] lg:mb-12'>¿Por que elegirnos?</h2>
        <div className='flex justify-center  mb-8  gap-2'>
            <div className='hidden relative md:block w-[50%]'>
        ...
        <button className='bg-[#00A6FB] justify-self-start text-white font-lato font-bold text-[18px] rounded-md py-[5px] px-[10px]'>
        ¡PRESUPUESTA TU WEB!
        </button>
            </div>

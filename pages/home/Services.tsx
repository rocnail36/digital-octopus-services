...
const Services = () => {
  return (
    <div id='services' className='bg-[#D9D9D9] animation_image flex flex-col items-center font-lato pt-4 pb-16 text-center px-[10px]'>
        ...
        <div className='font-lato max-w-[935px] grid gap-5 mt-[-28px] justify-center md:grid-cols-3 lg:mt-[-40px] xl:max-w-[1200px] xl:mt-[-64px]'>
